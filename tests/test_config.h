...
#define moro8_assert_zp_word_equal(cpu, offset, value) \
	{                                                  \
		moro8_uword __value = 0;                       \
		moro8_get_zp_word(cpu, offset, __value);       \
		assert_int_equal(__value, value);              \
	}
#define moro8_assert_ram_word_equal(cpu, offset, value) \
	{                                                   \
		moro8_uword __value = 0;                        \
		moro8_get_ram_word(cpu, offset, __value);       \
		assert_int_equal(__value, value);               \
	}
